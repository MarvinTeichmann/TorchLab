...
class WarpingSegmentationLoader(loader.LocalSegmentationLoader):
    ...
    def _read_lst_file(self):
        ...
        for sequence in self.conf['sequence']:
            ...
            seqdir = os.path.join(
                self.traindir, sequence, 'posenet_info')
    ...
    def __getitem__(self, idx):
        ...
        sample = {
            'image': image,
            'rotation': npz_file['R_quaternion'],
...
if __name__ == '__main__':  # NOQA
    ...
    config['sequence'] = "camvid_360_cvpr18_P2_training_data/part_03_seq_016E5_P2_A_R94_08010_09059/" # NOQA
    config['subsample'] = 0
