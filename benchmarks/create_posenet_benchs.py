...
conf = "../config/posenet.json"

gpus = '0'

names = ['part_03', 'part_04', 'part_05', 'part_06', 'part_07']

bench_name = "PoseBench"

keys = ['dataset.sequence',
        'dataset.sequence',
        'dataset.sequence',
        'dataset.sequence',
        'dataset.sequence']
...
values = [
    "camvid_360_cvpr18_P2_training_data/part_03_seq_016E5_P2_A_R94_08010_09059/", # NOQA
    "camvid_360_cvpr18_P2_training_data/part_04_seq_016E5_P2_B_R94_09060_10380/", # NOQA
    "camvid_360_cvpr18_P2_training_data/part_05_seq_016E5_P3_R94_10620_11190/",
    "camvid_360_cvpr18_P2_training_data/part_06_seq_001TP_P1_R94_21060_22229",
    "camvid_360_cvpr18_P2_training_data/part_07_seq_001TP_P2_R94_22230_23100"
]


print_str = "pv2 train --gpus %s {}" % gpus

dataset = "camvid_360_cvpr18_P2_training_data/part_06_seq_001TP_P1_R94_21060_22229/" # NOQA
